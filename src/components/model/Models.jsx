...
import "./Models.css"
const Modals = ({ show, item, onClose }) => {
    if (!show) {
        return null;
    }
                ...
                <div className="overlay-inner">
                    ...
                    <div className="inner-box">
                        ...
                        <div className="info">
                            ...
                            <h3>{item.volumeInfo.authors ? item.volumeInfo.authors.join(', ') : 'Unknown Author'}</h3>
                    ...
                    <h4 className="description">{item.volumeInfo.description || 'No description available.'}</h4>
                </div>
            </div>
        </>
    );
